...
RERANK_MODEL_PATH = "E:/Python_Projects/ai_knowledge_base/models/models/BAAI--bge-reranker-base/snapshots/master"
DEVICE = "cpu"
SEARCH_TOP_K = 10
RERANK_TOP_K = 3
...
SAVE_JSON_PATH = "E:/Python_Projects/ai_knowledge_base/app/evaluation/results/retrieval_result.json"
